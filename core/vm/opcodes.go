...
const APPROVE OpCode = 0xaa

// 0xb0 range - EIP-8141 frame transaction introspection operations.
const (
	TXPARAM           OpCode = 0xb0
...
var opCodeToString = [256]string{
	...
	SIGPARAM:          "SIGPARAM",
	RECENTROOTREFLOAD: "RECENTROOTREFLOAD",
