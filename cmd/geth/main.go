...
var (
	...
	nodeFlags = slices.Concat([]cli.Flag{
		...
		utils.FramePoolValidationMemoMaxBytesFlag,
		utils.FramePoolMaxPendingPerSenderFlag,
		utils.FramePoolMaxPendingPerNonCanonicalPaymasterFlag,
		utils.FramePoolMaxSizeFlag,
		utils.FramePoolResetWorkersFlag,
		utils.FramePoolAllowUnsafeBenchmarkPolicyFlag,
		utils.FramePoolPayerSolvencyPreflightFlag,
		utils.FramePoolPayerCodeIdentityPreflightFlag,
		utils.FramePoolSelectiveRevalidationFlag,
